function [trainedModel,trainingModel,normalizeValues,objectImage,bset,oset,bsetaux] = doFirstStep(I,rectangleContenidor,numberBlocksY,numberBlocksX,trainingModel,secondAproximationType)
    [nr,nc]= size(I(:,:,1));
